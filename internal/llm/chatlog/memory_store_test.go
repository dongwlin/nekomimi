...
func TestMemoryStore_AppendListPaginationAndLimit(t *testing.T) {
...
func TestMemoryStore_AppendNormalizesAndCopiesEntry(t *testing.T) {
	store := NewMemoryStore()
...
func assertEntryContents(t *testing.T, entries []Entry, want []string) {
	t.Helper()
